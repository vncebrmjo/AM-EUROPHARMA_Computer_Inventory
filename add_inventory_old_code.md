   ...
   <div class="col-md-1 mx-5">  <button id="user_button" class="btn btn-light" type="button" data-bs-toggle="modal" data-bs-target="#modal_user"><a href="#"><img src="static/icons/user_2.png" id="user"></a></button>User</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-3" id="dept_combo_box">
...
<br>
    ...
    <div class="col-md-1 mx-5"> <button id="processor_button" class="btn btn-light" type="button" data-bs-toggle="modal" data-bs-target="#modal_processor"><a href="#"> <img src="static/icons/processor.png" id="processor"></a></button>Processor</div>
    ...
    <div class="col-md-1 mx-5  "> <button id="power_suppy_button" class="btn btn-light " type="button"  data-bs-toggle="modal" data-bs-target="#modal_powersupply"><a href="#"> <img src="static/icons/power-supply.png" id="PS"></a></button>Power Supply</div>
...
<div class ="row justify-content-center" id="bottom_set">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-3" id="gb_combo_box">
...
<!--          <div class="col-md-3" id="op_stat">-->
<!--          <label class="fw-semibold">STATUS</label>-->
<!--              <div class="btn-group" role="group" aria-label="Basic radio toggle button group">-->

<!--  <input type="radio" class="btn-check" name="btn_opstat" id="btn_opstat_true" autocomplete="off" checked>-->
<!--  <label class="btn btn btn-outline-success" for="btn_opstat_true" id="btn_eset">Active</label>-->

<!--  <input type="radio" class="btn-check" name="btn_opstat" id="btn_opstat_false" autocomplete="off">-->
...
<!--             </div>-->
  ...
  <input value="Inactive" type="radio" class="btn-check" name="btn_eset" id="btn_eset_false" autocomplete="off">
  ...
  <label class="btn btn btn-outline-success" for="btn_ups_true" id="btn_eset"><img src="static/icons/check.png" class="img-fluid" id="check_button"></label>
...
<!--            <input class="form-check-input" type="checkbox"  name="ESET">-->
<!--                <label class= "form-check-label" >ESET</label>-->
<!--          </div>-->

<!--          <div class="col-md-3 form-check">-->
<!--            <input class="form-check-input" type="checkbox"  name="UPS">-->
...
<div class ="row justify-content-center">
   <div class="col-md-1 mx-5">  <button id="user_button" class="btn btn-light" type="button"> <a href="#">  <img src="static/icons/user_2.png" id="user"></a></button>User</div>
    <div class="col-md-1 mx-5"> <button id="processor_button" class="btn btn-light" type="button"><a href="#"> <img src="static/icons/processor.png" id="processor"></a></button>Processor</div>
    <div class="col-md-1 mx-5"> <button id="motherboard_button" class="btn btn-light" type="button"><a href="#"> <img src="static/icons/motherboard.png" id="Mobo"></a></button>Motherboard</div>
    <div class="col-md-1 mx-5"> <button id="power_suppy_button" class="btn btn-light" type="button"><a href="#"> <img src="static/icons/power-supply.png" id="PS"></a></button>PowerSupply</div>
</div>
<br>
<br>
<div class ="row justify-content-center">
    <div class="col-md-1 mx-5"> <button id="ram_button" class="btn btn-light" type="button"> <a href="#"> <img src="static/icons/ram.png" id="ram"></a></button>RAM</div>
    <div class="col-md-1 mx-5"> <button id="storage_button" class="btn btn-light" type="button"> <a href="#"> <img src="static/icons/storage.png" id="storage"></a></button>Storage</div>
    <div class="col-md-1 mx-5"> <button id="os_button" class="btn btn-light" type="button"> <a href="#"> <img src="static/icons/operating_system.png" id="OS"></a></button>OperatingSystem</div>
    <div class="col-md-1 mx-5"> <button id="status_button" class="btn btn-light" type="button"> <a href="#"> <img src="static/icons/device_status.png" id="status"></a></button>DeviceStatus</div>
</div>
<br>
<br>
